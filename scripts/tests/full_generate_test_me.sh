...
-i Toucan-1.5M/Toucan-1.5M \
-o /home/unlimitediw/workspace/datasets/mydataset/Toucan-1.5M-obf \
--alias stats/function_alias.json \
--workers 32

python scripts/analysis/function_stats.py \
-i /home/unlimitediw/workspace/datasets/mydataset/Toucan-1.5M-obf \
...
-i /home/unlimitediw/workspace/datasets/mydataset/Toucan-1.5M-obf  \
-o /home/unlimitediw/workspace/datasets/mydataset/Toucan-1.5M-generate \
-s stats/function_stats.json \
--workers 32 \
--param-pool stats/param_pool.json

python scripts/data_postprocess/assemble_toucan.py -i /home/unlimitediw/workspace/datasets/mydataset/Toucan-1.5M-obf -m /home/unlimitediw/workspace/datasets/mydataset/Toucan-1.5M-generate --workers 16