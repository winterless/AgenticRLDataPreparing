toucan_name="toucan2"
python scripts/data_preprocess/generate_toucan.py -i Toucan-1.5M/Toucan-1.5M/Kimi-K2/train-00000-of-00040.parquet --sample-size 1 --seed 3005 -o data/${toucan_name}.jsonl
